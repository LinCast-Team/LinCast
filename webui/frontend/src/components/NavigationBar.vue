<template>
  <div v-show="!hidden" id="nav" class="grid grid-cols-3 z-50 justify-items-center text-gray-50 bg-real-gray px-4 md:px-16 lg:px-40">
...
export default {
  ...
  setup() {
    ...
    const bookmarkIcon = computed(() => feather.icons.bookmark.toSvg({ class: '' }));
