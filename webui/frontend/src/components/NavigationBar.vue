<template>
  <div class="grid grid-cols-3 z-50 justify-items-center text-secondary-dt bg-primary-dt px-4 md:px-16 lg:px-40">
...
export default defineComponent({
  setup() {
    ...
    const bookmarkIcon = computed(() => feather.icons.menu.toSvg({ class: '' }));
