...
<div class="flex flex-col border-2 border-solid border-gray-100 bg-gray-50 rounded-t-xl z-100 fixed bottom-0 right-0 left-0 shadow-lg">
  <div class="flex rounded-t-xl">
    <div class="flex-shink order-1 my-auto">
      <img :src="artworkSrc" :alt="podcastTitle + '\'s artwork'" class="w-24 h-24 md:w-28 md:h-28 m-1 rounded-xl">
    </div>
    <div class="flex-grow order-2">
      <div id="waveform" class="bg-gray-50 mx-2"></div>
