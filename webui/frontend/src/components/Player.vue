...
<div class="flex flex-col border-2 border-solid border-gray-100 bg-gray-50 rounded-t-xl z-100 shadow-lg font-sans" :class="{ 'fixed bottom-0 right-0 left-0 top-0': !expanded }">
  <div class="flex flex-col text-center items-center mb-6 mt-4 md:mt-8 lg:mt-14">
    <img :src="artworkSrc" :alt="podcastTitle + '\'s artwork'" class="w-72 h-72 md:w-80 md:h-80 mx-1 my-6 rounded-md shadow-lg">
    <div class="grid grid-cols-4 grid-flow-col gap-2 items-center justify-items-center">
  ...
  <div id="waveform" class="bg-gray-50 mx-4 my-6"></div>
